...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Mar 19, 2022 at 04:47 PM
...
-- Database: `kfactory`
--
CREATE DATABASE IF NOT EXISTS `kfactory` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
USE `kfactory`;
...
(3, 8, 134567890001, '2026-02-18', 456, 14649.9),
...
(20, 32, 332345654654645, '2024-08-27', 855, 9440.02),
(19, 28, 8889999888899, '2022-04-08', 132, 8530.06),
(21, 32, 85613213213213213, '2024-04-17', 464, 10570),
(23, 36, 313216468456, '2024-10-30', 225, 9400.01);
...
(38, 'nvartanyan', 'Nadida', 'Vartanyan', '1234 South St', '', 'Logan', 'UT', '84225', '$2y$10$hCogMo.C0J7fGxVc3JujM.I.yvr8rdjzCq/CQeF.1yq3ud/pubyK.', '');
...
(49, 28, '2022-03-19 16:31:17', 'Kastle', 3, 499.99, 1, 0, 0, 1),
(50, 28, '2022-03-19 16:37:42', 'Rossignol', 9, 569.99, 1, 0, 0, 0),
(51, 28, '2022-03-19 16:40:02', 'Black Crowes', 8, 899.95, 1, 0, 1, 0),
(52, 32, '2022-03-19 16:41:06', 'Volkl', 5, 279.99, 1, 0, 0, 0),
(53, 32, '2022-03-19 16:41:17', 'Rossignol', 9, 569.99, 1, 0, 0, 1),
(54, 32, '2022-03-19 16:41:36', 'Volkl', 5, 279.99, 1, 0, 1, 0),
(55, 38, '2022-03-19 16:42:58', 'Atomic', 1, 599.99, 1, 0, 0, 0),
(56, 38, '2022-03-19 16:43:05', 'Kastle', 3, 499.99, 1, 0, 0, 1),
(57, 8, '2022-03-19 16:44:07', 'DPS', 2, 649.99, 1, 0, 0, 1),
(58, 36, '2022-03-19 16:44:45', 'Rossignol', 9, 569.99, 1, 0, 0, 1),
(59, 36, '2022-03-19 16:44:52', 'Salomon', 4, 599.99, 1, 0, 0, 1),
(60, 36, '2022-03-19 16:44:56', 'Atomic', 1, 599.99, 1, 0, 0, 0);
...
('2022-03-19 10:31:17', 49, 28, 19),
('2022-03-19 10:37:42', 50, 28, 19),
('2022-03-19 10:40:02', 51, 28, 19),
('2022-03-19 10:41:06', 52, 32, 20),
('2022-03-19 10:41:17', 53, 32, 20),
('2022-03-19 10:41:36', 54, 32, 20),
('2022-03-19 10:42:58', 55, 38, 22),
('2022-03-19 10:43:05', 56, 38, 22),
('2022-03-19 10:44:07', 57, 8, 4),
('2022-03-19 10:44:45', 58, 36, 23),
('2022-03-19 10:44:52', 59, 36, 23),
('2022-03-19 10:44:56', 60, 36, 23);
...
(1, 'Atomic', 'A super light carbon ski that is designed to go fast uphill and down', 'ski', 599.99, 10, 179, 'img/atomic.png', 9),
(2, 'DPS', 'A great all mountain ski for the resort, fun on groomers and fun in powder.', 'ski', 649.99, 15, 179, 'img/dps.png', 11),
(3, 'Kastle', 'A lightweight short ski, excellent for steep narrow couloirs with the bulletproof Dynafit Speedturn binding', 'ski', 499.99, 20, 169, 'img/kastle.png', 14),
...
(5, 'Volkl', 'A beater pair for the resort designed to take hits and rocks at speed', 'ski', 279.99, 9, 179, 'img/volkl.png', 5),
(8, 'Black Crowes', 'A very trendy brand and perhaps not as amazing as people seem to think but still fun to ski', 'ski', 899.95, 55, 185, 'img/somethings_missing.jpg', 4),
(9, 'Rossignol', 'A classic ski from a generation ago that still rips and grips', 'ski', 569.99, 89, 170, 'img/somethings_missing.jpg', 15);
...
(1, 'ptex', '2022-03-18', 173),
(2, 'steel_edges', '2022-03-18', 82),
(3, 'plastic', '2022-03-13', 34);
...
(30, 58, '2022-03-19 10:44:58', 1, 0),
(29, 57, '2022-03-19 10:44:13', 1, 0),
(28, 56, '2022-03-19 10:43:09', 1, 0),
(27, 53, '2022-03-19 10:41:38', 1, 1),
...
(23, 46, '2022-03-18 13:30:53', 1, 1),
(24, 47, '2022-03-18 13:34:34', 1, 0),
(25, 48, '2022-03-18 13:47:04', 1, 1),
(26, 49, '2022-03-19 10:37:47', 1, 0),
(31, 59, '2022-03-19 10:45:02', 1, 0);
...
(54, '2022-03-19 10:42:17', '2022-03-19 10:42:17', 15, 'UPS'),
(51, '2022-03-19 10:42:19', '2022-03-19 10:42:19', 15, 'UPS');
...
(32, 'mthomas', 'Megan', 'Thomas', '8899 Draper Way', '', 'Draper', 'UT', '45646', '$2y$10$3yS/7BUvJ/gASkDi4G2UCePQevlcUlfqzTy2RWE9dRPdpMJrM5ZPe', 'img/smiley.jpg'),
(33, 'aaarons', 'Aaron', 'Aarons', '213 Dew Drive', '', 'Salt Lake City', 'UT', '74556', '$2y$10$6vaGt8rSvmDZp63tjHlEYexJtR0sN4c5/1h6oOhJjPNqrLrJsZVje', 'img/smiley.jpg'),
(34, 'rpangan', 'Reese', 'Pangan', '999 West Way', '', 'Layton', 'UT', '84456', '$2y$10$Ex0bvz/WPT2kza4xz.sjXeLBlAfWf3aLmHpmr2/Vh5HKw1dOK7ysK', 'img/smiley.jpg'),
(35, 'jmcrill', 'Jaxen', 'Mcrill', '998 West St', '', 'Orem', 'UT', '54646', '$2y$10$B9nTl7JEelxv0lZhMaHIE.MdU4LiKk52oJ4PiW0Offl5PZ.3WClla', 'img/smiley.jpg'),
(36, 'acoe', 'Arlin', 'Coe', '863 Dele St', 'Apt 4', 'Salt Lake City', 'UT', '45646', '$2y$10$4QI7QtieWjKDbIWPz.omfe79KtPn9FCn1W0jYDXREv.Y4CQm1j4b.', 'img/smiley.jpg'),
(37, 'cmisrahi', 'Camila', 'Misrahi', '8992 East St', 'Apt 222A', 'Provo', 'UT', '65665', '$2y$10$cgrLCJUc9IrJx3YXyxDou.IBrjrYKx3IH66o2ms5efG7ejOFiiWRK', 'img/smiley.jpg'),
(39, 'gwickliff', 'Granada', 'Wickliff', '699 Marigold Way', 'Apt 11', 'West Valley', 'UT', '66996', '$2y$10$iYCkaNM18064juV9GdnX2ebkCcUEl2FUyXHLAFKLdmBu5g/J6h.vO', 'img/smiley.jpg');
COMMIT;
